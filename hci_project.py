...
label=Label(text="LASYA SCHOOL MANAGEMENT",font=("times new roman",35),bg="black",fg="white")
...
def second():
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="LASYA SCHOOL MANAGEMENT", font=("times new roman", 35), bg="black",fg="white")
    mainlabel.pack(side=TOP, fill=X)
